...
const QuizResults = ({result,hideStartNew = false , onStartNew}) => {
  if (!result) {
    return null;
  }
  return (
      ...
      <CardContent>
        ...
        <div className="text-center space-y-2">
          <h3 className="text-2xl font-semibold" > {result.quizScore.toFixed(1)}% </h3>
        ...
        <div className='space-y-4 mt-4 left-1 '>
